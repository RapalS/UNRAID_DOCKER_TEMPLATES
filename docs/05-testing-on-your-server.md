...
./scripts/install-to-unraid.sh templates/my-app.xml
```
...
## Example smoke test (NornicDB)

See [apps/nornicdb.md](apps/nornicdb.md). Quick check: WebUI on port `7474`, `curl http://YOUR_UNRAID_IP:7474/health` returns 200.
